...
func FormField() string {
	return "font-sans py-1.5 pl-2 pr-2 border border-border-default-secondary w-full rounded-lg text-base outline-none bg-background text-foreground tracking-tight caret-foreground-accent placeholder:text-foreground-default-tertiary box-border disabled:bg-background-default-secondary disabled:text-foreground-default-tertiary hover:enabled:border-border-default-secondary-hover focus:hover:enabled:border-border-selected-bold focus:ring-0 focus:ring-offset-0"
}
